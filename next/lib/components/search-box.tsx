    ...
    useEffect(() => {
        ...
        if (index !== null) {
            ...
            if (id) {
                ...
                router.replace(idToUrl(config, id, newParams))
            }
        }
    }, [offset])
                    ...
                    { rows.map((item, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <TableCell sx={sxCell}><Link href={idToUrl(config, item.id, searchParams)}>{item.date}</Link></TableCell>
                                <TableCell sx={sxCell}><Link href={idToUrl(config, item.id, searchParams)}>{item.title}</Link></TableCell>
                                <TableCell sx={sxCell}>
                                    {
