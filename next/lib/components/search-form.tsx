...
const SearchForm = () => {
    ...
    const { pathManager } = mapContext.state
    ...
    const handleChange = (setter) => useCallback( (e) => {
    ...
    return (
        <Box sx={{ margin: 1 }}>
            ...
            <div>
                ...
                <TextField id="searchForm_limit" label="limit" name="limit" value={limit} onChange={handleChange(setLimit)} sx={sxFormInput} variant="standard" />
            </div>
